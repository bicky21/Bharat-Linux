...
gldelf_x86_64_after_open (void)
{
  ldelf_after_open (true, true,
		    true, false, 64, "/bharat-linux/tools");
}
...
OUTPUT_ARCH(i386:x86-64)\n\
ENTRY(_start)\n\
SEARCH_DIR(\"=/bharat-linux/tools/x86_64-pc-linux-gnu/lib64\"); SEARCH_DIR(\"=/bharat-linux/tools/lib64\"); SEARCH_DIR(\"=/usr/local/lib64\"); SEARCH_DIR(\"=/lib64\"); SEARCH_DIR(\"=/usr/lib64\"); SEARCH_DIR(\"=/bharat-linux/tools/x86_64-pc-linux-gnu/lib\"); SEARCH_DIR(\"=/bharat-linux/tools/lib\"); SEARCH_DIR(\"=/usr/local/lib\"); SEARCH_DIR(\"=/lib\"); SEARCH_DIR(\"=/usr/lib\");\n\
SECTIONS\n\
{\n\
