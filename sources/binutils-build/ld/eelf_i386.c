...
gldelf_i386_after_open (void)
{
  ldelf_after_open (true, true,
		    true, false, 32, "/bharat-linux/tools");
}
...
OUTPUT_ARCH(i386)\n\
ENTRY(_start)\n\
SEARCH_DIR(\"=/bharat-linux/tools/i386-pc-linux-gnu/lib32\"); SEARCH_DIR(\"=/bharat-linux/tools/x86_64-pc-linux-gnu/lib32\"); SEARCH_DIR(\"=/bharat-linux/tools/lib32\"); SEARCH_DIR(\"=/usr/local/lib32\"); SEARCH_DIR(\"=/lib32\"); SEARCH_DIR(\"=/usr/lib32\"); SEARCH_DIR(\"=/bharat-linux/tools/i386-pc-linux-gnu/lib\"); SEARCH_DIR(\"=/bharat-linux/tools/lib\"); SEARCH_DIR(\"=/usr/local/lib\"); SEARCH_DIR(\"=/lib\"); SEARCH_DIR(\"=/usr/lib\");\n\
SECTIONS\n\
{\n\
